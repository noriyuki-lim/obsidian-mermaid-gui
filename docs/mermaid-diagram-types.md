...
| #  | 図種別                  | キーワード                 | ステータス |
| -- | -------------------- | --------------------- | ----- |
| 1  | Flowchart            | `flowchart` / `graph` | 安定    |
| 2  | Sequence Diagram     | `sequenceDiagram`     | 安定    |
| 3  | Class Diagram        | `classDiagram`        | 安定    |
| 4  | State Diagram        | `stateDiagram-v2`     | 安定    |
