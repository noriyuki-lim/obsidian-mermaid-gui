...
│   │   ├── keyboard.ts
│   │   ├── canvas/            # FlowCanvas.tsx + FlowchartCanvasControls.tsx（Direction / Subgraph / Auto-layout を canvas 左上に縦配置）
│   │   ├── panels/            # Palette.tsx（Shapes 追加パレット）
